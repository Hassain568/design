...
<body>
    ...
    <div class="container">
     ...
     <div id="main_area2">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="col-xs-12" id="slider">
                        ...
                        <div class="row">
                            <div class="col-sm-12" id="carousel-bounding-box">
                                <div class="carousel slide" id="myCarousel2" data-ride="carousel" data-interval="false">
                                    <!-- Carousel items -->
                                    <div class="carousel-inner">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="col-xs-12" id="slider">
                        ...
                        <div class="row">
                            <div class="col-sm-12" id="carousel-bounding-box">
                                <div class="carousel slide" id="myCarousel3" data-ride="carousel" data-interval="false">
                                    <!-- Carousel items -->
                                    <div class="carousel-inner">
      ...
      <div class="col-sm-10">
        <input type="name" class="form-control" id="kit" placeholder="ادخل اسم الطقم" name="name">
      </div>
    </div>
